...
Hi! I’m a final year PhD student at Oxford, supervised by [Jakob Foerster](https://www.jakobfoerster.com/) as part of [FLAIR](https://foersterlab.com/), and [Yee Whye Teh](https://www.stats.ox.ac.uk/~teh/) as part of [OXCSML](https://csml.stats.ox.ac.uk/).
...
Before coming to Oxford, I completed an integrated Masters in Computer and Information Engineering at the University of Cambridge, where I did my dissertation on language models for automatic speech recognition supervised by [Phil Woodland](https://www.eng.cam.ac.uk/profiles/pw117), and also worked with [José Miguel Hernández-Lobato](https://jmhl.org/) in the [Cambridge Machine Learning Group (MLG)](https://mlg.eng.cam.ac.uk/people/) on causal representation learning.
